...
void main() {
  group('blake2b512 test', () {
    ...
    test('with a secret', () {
      expect(
          Blake2b(toBytes('secret')).string("a").hex(),
    ...
    test('with empty string and a secret', () {
      expect(
          Blake2b(toBytes('secret')).string('').hex(),
  ...
  group('blake2b256 test', () {
    ...
    test('with empty string and a secret', () {
      expect(Blake2b(toBytes('secret'), 256).string('').hex(),
          "080989147a9b01f885f00d9b90cee0855cfb08aa68d57dc2c92333b2df70a5ea");
    });
    test('with abc and a secret', () {
      expect(Blake2b(toBytes('secret'), 256).string('abc').hex(),
  ...
  group('blake2b160 test', () {
    ...
    test('with empty string and a secret', () {
      expect(Blake2b(toBytes('secret'), 160).string('').hex(),
          "f8630ddf0a315edbc8977f2c52040e9cedb70a85");
    });
    test('with abc and a secret', () {
      expect(Blake2b(toBytes('secret'), 160).string('abc').hex(),
