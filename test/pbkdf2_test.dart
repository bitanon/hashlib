...
void main() {
  group('PBKDF2 test', () {
    test("name", () {
      ...
      expect(sha256.pbkdf2(key).name, 'SHA-256/HMAC/PBKDF2');
      expect(sha256.hmac.pbkdf2(key).name, 'SHA-256/HMAC/PBKDF2');
      expect(sha1.pbkdf2(key).name, 'SHA1/HMAC/PBKDF2');
      expect(sha1.hmac.pbkdf2(key).name, 'SHA1/HMAC/PBKDF2');
      expect(md5.pbkdf2(key).name, 'MD5/HMAC/PBKDF2');
      expect(md5.hmac.pbkdf2(key).name, 'MD5/HMAC/PBKDF2');
    });
    ...
    test("with MD5", () {
      ...
      final output = md5.pbkdf2(iv, 100, 32).hex(pw);
    ...
    test("with MD5 through HMAC", () {
      ...
      final output = md5.pbkdf2(iv, 100, 16).hex(pw);
      expect(output, equals(result));
    });
    ...
    test("with SHA-1", () {
      ...
      final output = sha1.pbkdf2(iv, 100, 32).hex(pw);
      expect(output, equals(result));
    });
    ...
    test("with SHA-224", () {
      ...
      var output = sha224.pbkdf2(iv, 50, 32).hex(pw);
      var matcher =
    ...
    test("with SHA-256", () {
      var pw = 'password'.codeUnits;
      var iv = "some salt".codeUnits;
      var output = sha256.pbkdf2(iv, 50, 32).hex(pw);
      var matcher =
          '09d106dccc35eae63c48aa472394de511547ce296ab55685b7ba8b304bec68fe';
      expect(output, equals(matcher));
    });
    ...
    test("with SHA-384", () {
      var pw = 'password'.codeUnits;
      var iv = "some salt".codeUnits;
      var output = sha384.pbkdf2(iv, 50, 32).hex(pw);
      var matcher =
    ...
    test("with SHA-512", () {
      var pw = 'password'.codeUnits;
      var iv = "some salt".codeUnits;
      var output = sha512.pbkdf2(iv, 50, 32).hex(pw);
      var matcher =
    ...
    test("with SHA-512/224", () {
      var pw = 'password'.codeUnits;
      var iv = "some salt".codeUnits;
      var output = sha512t224.pbkdf2(iv, 50, 32).hex(pw);
      var matcher =
    ...
    test("with SHA-512/256", () {
      var pw = 'password'.codeUnits;
      var iv = "some salt".codeUnits;
      var output = sha512t256.pbkdf2(iv, 50, 32).hex(pw);
      var matcher =
    ...
    test("with SHA3-224", () {
      var pw = 'password'.codeUnits;
      var iv = "some salt".codeUnits;
      var output = sha3_224.pbkdf2(iv, 50, 32).hex(pw);
      var matcher =
    ...
    test("with SHA3-256", () {
      var pw = 'password'.codeUnits;
      var iv = "some salt".codeUnits;
      var output = sha3_256.pbkdf2(iv, 50, 32).hex(pw);
      var matcher =
    ...
    test("with SHA3-384", () {
      var pw = 'password'.codeUnits;
      var iv = "some salt".codeUnits;
      var output = sha3_384.pbkdf2(iv, 50, 32).hex(pw);
      var matcher =
    ...
    test("with SHA3-512", () {
      var pw = 'password'.codeUnits;
      var iv = "some salt".codeUnits;
      var output = sha3_512.pbkdf2(iv, 50, 32).hex(pw);
      var matcher =
