...
void main() {
  group('Argon2 v19 test', () {
    test("argon2i v=19 m=16, t=2, p=1 @ out = 16", () {
      ...
      final digest = argon2.encode('password'.codeUnits).hex();
      final matcher = "bb5794ea66451b8fce3a84dd02d33949";
      expect(digest, matcher);
    }, tags: 'skip-js');
    test("argon2d v=19 m=16, t=2, p=1 @ out = 16", () {
      final argon2 = Argon2Context(
        version: Argon2Version.v13,
    ...
    test("argon2id v=19 m=16, t=2, p=1 @ out = 16", () {
      final argon2 = Argon2Context(
        version: Argon2Version.v13,
    ...
    test("argon2i v=19 m=8192, t=8, p=4 @ out = 32", () {
      final argon2 = Argon2Context(
        version: Argon2Version.v13,
        hashType: Argon2Type.argon2i,
        hashLength: 32,
    ...
    test("argon2d v=19 m=8192, t=8, p=4 @ out = 32", () {
      final argon2 = Argon2Context(
        version: Argon2Version.v13,
        hashType: Argon2Type.argon2d,
        hashLength: 32,
    ...
    test("argon2id v=19 m=8192, t=8, p=4 @ out = 32", () {
      final argon2 = Argon2Context(
        version: Argon2Version.v13,
        hashType: Argon2Type.argon2id,
        hashLength: 32,
