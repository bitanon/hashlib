...
void main() {
  group('Keccak test', () {
    test('SHA3-224 with empty string', () {
      final hash = SHA3d224Hash();
      expect(hash.digest().hex(),
    ...
    test('SHA3-256 with short message', () {
      ...
      final hash = SHA3d256Hash();
      hash.add(fromHex(input));
      expect(hash.digest().hex(), output);
    });
