...
/// SHA-384 is a member of SHA-3 family which uses 384-bit blocks to
...
const HashBase sha3_384 = _SHA3d384();

class _SHA3d384 extends HashBase {
  const _SHA3d384();

  @override
  SHA3d384Hash startChunkedConversion([Sink<HashDigest>? sink]) =>
      SHA3d384Hash();
}
